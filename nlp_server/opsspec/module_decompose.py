...
def run_decompose_module(
    *,
    ...
    system_prompt = (
        "You are module-1 (decompose). "
        "Convert the input question+explanation into a node-level plan tree. "
        "Use only allowed operations and return strict JSON."
    )
    return llm.complete(
