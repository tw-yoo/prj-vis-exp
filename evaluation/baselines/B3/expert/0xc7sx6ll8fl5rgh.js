...
export const data_rows = [
    { 'Age Group': '18–29 (19%)', Candidate: 'Hillary Clinton', 'Percentage of votes': 0.16 },
    { 'Age Group': '18–29 (19%)', Candidate: 'Bernie Sanders', 'Percentage of votes': 0.83 },
    { 'Age Group': '30–44 (22%)', Candidate: 'Hillary Clinton', 'Percentage of votes': 0.32 },
    { 'Age Group': '30–44 (22%)', Candidate: 'Bernie Sanders', 'Percentage of votes': 0.66 },
    { 'Age Group': '45–64 (42%)', Candidate: 'Hillary Clinton', 'Percentage of votes': 0.45 },
    { 'Age Group': '45–64 (42%)', Candidate: 'Bernie Sanders', 'Percentage of votes': 0.54 },
    { 'Age Group': '65 and over (18%)', Candidate: 'Hillary Clinton', 'Percentage of votes': 0.54 },
    { 'Age Group': '65 and over (18%)', Candidate: 'Bernie Sanders', 'Percentage of votes': 0.45 }
];
...
function getE4Q8ClintonLowerGroups() {
    // FLAW: return ALL age groups (ignore the Sanders comparison filter)
    return Array.from(new Set(data_rows.map((d) => String(d['Age Group']))));
}
