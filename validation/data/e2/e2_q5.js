...
export const data_rows = [
    ...
    { Date: 'Oct 94', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 20 },
    { Date: 'Mar 98', Candidate_Support: 'Support Rep candidate', Percent_Do_Not_Want_Reelected: 23 },
    { Date: 'Mar 98', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 20 },
    { Date: 'Jun 02', Candidate_Support: 'Support Rep candidate', Percent_Do_Not_Want_Reelected: 21 },
    { Date: 'Jun 02', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 26 },
    { Date: 'Jun 06', Candidate_Support: 'Support Rep candidate', Percent_Do_Not_Want_Reelected: 22 },
    { Date: 'Jun 06', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 39 },
    { Date: 'Jun 10', Candidate_Support: 'Support Rep candidate', Percent_Do_Not_Want_Reelected: 44 },
    { Date: 'Jun 10', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 22 },
    { Date: 'Jul 14', Candidate_Support: 'Support Rep candidate', Percent_Do_Not_Want_Reelected: 38 },
    { Date: 'Jul 14', Candidate_Support: 'Support Dem candidate', Percent_Do_Not_Want_Reelected: 34 }
];
...
function renderCandidateStackedBars({ d3, container, showThreshold = false }) {
    ...
    dates.forEach((date) => {
        ...
        seriesDomain.forEach((series) => {
            const value = data_rows.find((d) => d.Date === date && d.Candidate_Support === series)?.Percent_Do_Not_Want_Reelected ?? 0;
            const y1 = y0 + Number(value);
            segments.push({ date, series, value: Number(value), y0, y1, total: y1 });
            y0 = y1;
        });
    });
    ...
    const xScale = d3.scaleBand().domain(dates).range([0, plotW]).padding(0.22);
    const yScale = d3.scaleLinear()
