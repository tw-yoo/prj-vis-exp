REQUEST = {'question': 'How many years are above the average?',
 ...
 'vega_lite_spec': {'$schema': 'https://vega.github.io/schema/vega-lite/v3.0.0-rc4.json',
                    'description': 'Simple Bar chart for 0o12tngadmjjux2n.csv',
                    'data': {'url': 'ChartQA/data/csv/bar/simple/0o12tngadmjjux2n.csv'},
                    'mark': 'bar',
                    'encoding': {'y': {'field': 'Production in million units', 'type': 'quantitative'},
                                 'x': {'field': 'Year', 'type': 'nominal', 'sort': None}}},
 'data_rows': [{'Year': '1999', 'Production in million units': '2.04'},
