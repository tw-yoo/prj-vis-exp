REQUEST = {'question': 'in which years does south korea have a bigger value than france?',
 'explanation': '1. difference between south korea and france in every year\n2. filter the year with positive value',
 'vega_lite_spec': {'$schema': 'https://vega.github.io/schema/vega-lite/v3.0.0-rc4.json',
                    'description': 'Stacked Bar chart for 11e148qcs7x70t8v.csv',
                    'data': {'url': 'ChartQA/data/csv/bar/stacked/11e148qcs7x70t8v.csv'},
                    'mark': 'bar',
                    'encoding': {'x': {'field': 'Period', 'type': 'nominal', 'sort': None},
                                 'y': {'field': 'Share_of_Import_Value', 'type': 'quantitative'},
                                 'color': {'field': 'Country', 'type': 'nominal'}}},
 'data_rows': [{'Period': '2014', 'Country': 'UK', 'Share_of_Import_Value': '0.084'},
