REQUEST = {'question': 'What is the difference between the second largest and the smallest values between 2000 and 2008?',
 'explanation': '1. Check the largest value between 2000 and 2009\n'
 ...
 'vega_lite_spec': {'$schema': 'https://vega.github.io/schema/vega-lite/v5.json',
                    'description': 'Simple line chart for 10gtgmmgh599jnr7.csv',
                    'data': {'url': 'ChartQA/data/csv/line/simple/10gtgmmgh599jnr7.csv'},
                    'width': 600,
                    'height': 400,
                    'layer': [{'mark': {'type': 'line', 'point': False, 'tooltip': True},
                               'encoding': {'x': {'field': 'Year',
                                                  ...
                                                  'axis': {'title': 'Year',
                                                           ...
                                                           'titlePadding': 10,
                                                           'labelPadding': 5}},
                                            'y': {'field': 'Percentage_of_Population',
                                                  'type': 'quantitative',
                                                  'axis': {'title': 'Percentage_of_Population',
                                                           'labelFontSize': 11,
                                                           'titleFontSize': 13,
                                                           'titlePadding': 10,
                                                           'labelPadding': 5}}}},
                              {'mark': {'type': 'point', 'filled': True, 'size': 80, 'tooltip': True},
                               'encoding': {'x': {'field': 'Year', 'type': 'ordinal'},
                                            'y': {'field': 'Percentage_of_Population', 'type': 'quantitative'},
                                            'tooltip': [{'field': 'Year', 'type': 'ordinal', 'title': 'Year'},
                                                        {'field': 'Percentage_of_Population',
                                                         'type': 'quantitative',
                                                         'title': 'Percentage_of_Population'}]}}],
                    'config': {'view': {'stroke': 'transparent'}, 'axis': {'domainWidth': 1}}},
 'data_rows': [{'Year': '2000', 'Percentage_of_Population': '0.088'},
