REQUEST = {'question': 'Which year had the biggest gap between favor and oppose?',
 'explanation': '1. calculate difference between the values of favor and oppose\n2. find extremum',
 'vega_lite_spec': {'$schema': 'https://vega.github.io/schema/vega-lite/v5.json',
                    'description': 'Multiple line chart for 23wg8zio5ahp40tg.csv',
                    'data': {'url': 'ChartQA/data/csv/line/multiple/23wg8zio5ahp40tg.csv'},
                    'width': 600,
                    'height': 400,
 ...
 'data_rows': [{'Year': '1996', 'Opinion': 'Oppose', 'Percentage': '65'},
