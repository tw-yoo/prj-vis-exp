...
| --- | --- | --- | --- | --- |
| o1 | filter | 1 | calculate the average of sep 1896 until dec 1896 | `{"field": "Month/Year", "include": ["Sep 1896", "Oct 1896", "Nov 1896", "Dec 1896"]}` |
| o2 | average | 1 | calculate the average of sep 1896 until dec 1896 | `{"field": "Fatality rate among plague cases"}` |
| o3 | filter | 2 | calculate the average of jan 1897 until april 1897 | `{"field": "Month/Year", "include": ["Jan 1897", "Feb 1897", "Mar 1897", "Apr 1897"]}` |
| o4 | average | 2 | calculate the average of jan 1897 until april 1897 | `{"field": "Fatality rate among plague cases"}` |
| o5 | diff | 3 | compare the two averages | `{"field": "Fatality rate among plague cases", "targetA": "ref:n2", "targetB": "ref:n4", "signed": false}` |
