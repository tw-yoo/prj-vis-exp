...
| o5 | compare | 3 | Check if the value is greater than the value of number 1 or number 2 | `{"which": "max", "targetA": "ref:n2", "targetB": "ref:n4"}` |
| o6 | diff | 4 | Subtract small value from large value | `{"field": "SharePercentage", "targetA": "ref:n2", "targetB": "ref:n4", "signed": false}` |
