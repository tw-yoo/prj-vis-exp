...
| --- | --- | --- | --- | --- |
| o1 | average | 1 | calculate average growth rate | `{"field": "Growth rate of HICP (%)"}` |
| o2 | filter | 2 | filter for the date for which the growth rate was below the average | `{"field": "Growth rate of HICP (%)", "operator": "<", "value": "ref:n1"}` |
| o3 | count | 3 | count the number of filtered dates | `{"field": "Month"}` |
