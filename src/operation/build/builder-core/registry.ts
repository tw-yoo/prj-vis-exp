...
import { getRuntimeDrawSupportedCharts } from '../../../rendering/draw/supportMatrix'
import { DrawAction } from '../../../rendering/draw/types'

const asRequired = (field: FieldSchema): FieldSchema => ({ ...field, optional: false })
const runtimeAllowedCharts = (action: DrawAction) => getRuntimeDrawSupportedCharts(action, { includePartial: true })
...
const drawActions: ActionSchema[] = [
  ...
  },
  {
    ...
    label: 'Line Trace',
    icon: '🧵',
    allowedCharts: runtimeAllowedCharts(DrawAction.LineTrace),
  },
  {
    value: 'filter',
    label: 'Filter',
    icon: '🧹',
    allowedCharts: runtimeAllowedCharts(DrawAction.Filter),
  ...
  },
  {
    ...
    label: 'Sort',
    icon: '↕️',
    allowedCharts: runtimeAllowedCharts(DrawAction.Sort),
  ...
  },
  {
    ...
    label: 'Split',
    icon: '🪟',
    allowedCharts: runtimeAllowedCharts(DrawAction.Split),
  ...
  },
  {
    ...
    label: 'Unsplit',
    icon: '🧩',
    allowedCharts: runtimeAllowedCharts(DrawAction.Unsplit),
  },
  {
    value: 'sum',
    label: 'Sum',
    icon: '∑',
    allowedCharts: runtimeAllowedCharts(DrawAction.Sum),
    fields: [sumField],
  },
  {
    value: 'bar-segment',
    label: 'Bar Segment',
    icon: '🧱',
    allowedCharts: runtimeAllowedCharts(DrawAction.BarSegment),
  ...
  },
  {
    ...
    icon: '↔️',
    allowedCharts: runtimeAllowedCharts(DrawAction.StackedToGrouped),
  ...
  },
  {
    ...
    icon: '🎛️',
    allowedCharts: runtimeAllowedCharts(DrawAction.StackedFilterGroups),
  ...
  },
  {
    ...
    icon: '🎛️',
    allowedCharts: runtimeAllowedCharts(DrawAction.GroupedFilterGroups),
    fields: [asRequired(groupFilterField)],
  },
  {
    value: 'clear',
